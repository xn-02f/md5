...
describe('MD5 Test', function () {
    ...
    it('"' + example.name + '" Converted to MD5 Value Test.', function () {
        assert.equal(md5(example.name), md5Hash.name);
    });

    it('"' + example.email + '" Converted to MD5 Value Test.', function () {
        assert.equal(md5(example.email), md5Hash.email);
    });

    it('"' + example.url + '" Converted to MD5 Value Test.', function () {
